...
public:
    ...
    */
    ...
    HashMap& operator=(const HashMap<K, M, H>& other);
    ...
    friend std::ostream& operator<<(std::ostream& os, const HashMap<K_, M_, H_>& rhs);

    template <typename K_, typename M_, typename H_>
    friend bool operator!=(const HashMap<K_, M_, H_>& lhs, const HashMap<K_, M_, H_>& rhs);
